  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-4">
      ...
      >
        ...
        <select
          className="mt-2 mb-4 w-full p-3 bg-white/20 text-white border-none rounded-md outline-none"
        ...
        <input
          type="text"
          className="mt-2 mb-2 w-full p-3 bg-white/20 text-white border-none rounded-md outline-none"
          value={accountNumber}
