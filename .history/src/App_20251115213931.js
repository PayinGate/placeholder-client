...
function App() {
  useEffect(()=>{
    ...
    gw.Transaction.initialize({amount: 200, currency: "ngn", customer: {email: "awakintade@gmail.com"}, container: ".App"}).then((rate)=>{ console.log(rate, ) });
  }, [])
  return (
    <div className="App h-screen w-screen p-10">
      <div className='gap-2 h-full flex w-full justify-center'>
        ...
        <BankList />
        <div className='w'>
        {/* <iframe src='http://localhost:3001/pay/gwp_UqX0Eh16hMHgqksQfWges' width={"100%"} height={"100%"} title="a" style={{border: "0px"}} allow="clipboard-write"/> */}
        </div>
