...
export default function Item(){
    ...
    const removeCart = (name) => {
      ...
      const pay = () => {
        ...
        return <div className='mx-auto p-6 relative'><div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 '>
            {ITEMS.map((item, key) => {
        ...
        <span className="bubble-text">Pay N{noToLocale(total)}</span>
    </div>}
        </div>
}
